...
public interface ArticleMapper {
    ...
    List<Article> getArticleByState2(@Param("state") Integer state, @Param("start") Integer start, @Param("count") Integer count, @Param("uid") Long uid, @Param("keywords") String keywords);
//    List<Article> getArticleByStateByAdmin(@Param("start") int start, @Param("count") Integer count, @Param("keywords") String keywords);
    ...
    int getArticleCountByState2(@Param("state") Integer state, @Param("uid") Long uid, @Param("keywords") String keywords);
    ...
    int updateArticlePriorityById(@Param("articleId") Integer articleId, @Param("priority") Long priority);
