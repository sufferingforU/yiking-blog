...
public class SensitivewordFilter {
    ...
    public  static SensitivewordFilter getSensitivewordFilter(){
        return SensitiveWordInitalzer.instance;
    }
    private static class SensitiveWordInitalzer{
...
public String checkAndReplaceComments(String comment){
    Set<String> sensitiveWord = getSensitiveWord(comment, 2);
